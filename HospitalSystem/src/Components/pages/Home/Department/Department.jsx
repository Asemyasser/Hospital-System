...
function Department() {
  return (
    <section className="departments padding-tb pb-0">
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="departments-content">
              <div className="row">
                <div className="col-12">
                  <ul className="department-imgs mb-2 d-flex justify-content-center flex-wrap">
                    <li>
                      <a className="" href="">
                  ...
                  <div className="department-main">
                    <div className="row flex-row-reverse align-items-center">
                      <div className="col-12 col-lg-6">
                        <div className="post-img h-100 w-100">
                          <img
                            src={departmentMain}
                            className="w-100"
                            alt="department"

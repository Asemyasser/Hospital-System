            ...
            <footer className="w-100 d-flex flex-column justify-content-center align-items-center pt-5">
                <div className="w-75 row g-3">
                    <div className="footer-content-1 col-xl-3 col-lg-12 text-center text-xl-start">
                        ...
                        <p>
                            <FontAwesomeIcon icon={faHouseChimney} className="pe-2 text-primary" />Suite 02
                            New Elephant Road USA
                        </p>
                        <p>
                            <FontAwesomeIcon icon={faPhone} className="pe-2 text-primary" />+880 142 258 123,
                            02-96936
                        </p>
                        <p className="fw-semibold">
                            <FontAwesomeIcon icon={faEnvelope} className="pe-2 text-primary" />info@mukti.com
                        </p>
                        <p className="fw-semibold">
                            <FontAwesomeIcon icon={faGlobe} className="pe-2 text-primary" />info@mukti.com
                        </p>
                    </div>
                    ...
                    <div className="footer-content-2 col-xl-6 col-lg-12 d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div className="input-group mb-3">
                            <span className="input-group-text"><FontAwesomeIcon icon={faPaperPlane} className="text-primary"/></span>
                            <input
                            type="text"
                ...
                <p>
                    Copyright &copy; 2021 <span className="text-primary">Mukti</span> . All Rights
                    Reserved. By <span className="fw-bold text-black">LabArtisan</span>
                </p>
            </footer>
    )
}
